...
form.addEventListener('submit', async (e) => {
  ...
  const param2Input = document.getElementById('param3');
  const param3Input = document.getElementById('param2');
  const param4Input = document.getElementById('param4');
  const param5Input = document.getElementById('param5');

  const param1 = param1Input.value;
  const param2 = param2Input.value;
  const param3 = param3Input.value;
  const param4 = param4Input.value;
  const param5 = param5Input.value;
  ...
  if(param3 == 'Choose a level'){
    alert('Please choose a level of activity.')
    return;
  }

  if(param4 == 'Select City'){
  ...
  try {
    ...
    setTimeout(function () {
      button.innerHTML = '<i class="fa fa-spinner mr-1 loader"></i>Generating...';
    }, 3000);

    setTimeout(function () {
      button.innerHTML = '<i class="fa fa-spinner mr-1 loader"></i>Searching for locations...';
    }, 6000);

    setTimeout(function () {
      button.innerHTML = '<i class="fa fa-spinner mr-1 loader"></i>Looking for activites...';
    }, 7000);

    setTimeout(function () {
      button.innerHTML = '<i class="fa fa-spinner mr-1 loader"></i>Wrapping up...';
    }, 200000);
    ...
    function writeText() {
      if (i < responseData.response.length) {
        result.innerHTML += responseData.response.charAt(i);
        i++;
