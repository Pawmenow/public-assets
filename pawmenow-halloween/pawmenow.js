  ...
  var options = ['a Phantom 👻', 'a Flower 🌼', 'a Bat 🦇', 'a Cat 🐈', 'a Mouse 🐭', 'a Butterfly 🦋', 'a Pumpkin 🎃', 'a Rabbit 🐰', 'a Unicorn🦄', 'a Sheep 🐑', 'a Moose or Deer 🦌', 'a HotDog 🌭', 'a Vampire 🧛🏻‍♀️', 'a Strawberry 🍓', 'Scooby-Doo!', 'a Minion character! Banananaaa 🍌', 'Superman', 'a Surfer 🏄‍♂️', 'a Lion 🦁', 'Santa 🎅🏻', 'a Shark 🦈', 'Stitch from Lilo & Stitch', 'a Dinosaur 🦖', 'a Lobster 🦞', 'a Bee 🐝', 'an Angel 👼🏻', 'a Fairy 🧚‍♂️', 'with a stylish Halloween sweater 🧶', 'with a Halloween-themed bandana! Go simple this year and choose the best bandana for your dog.'];
   ...
   var dogs_can = `<img class="svg-image-dog" src="https://raw.githubusercontent.com/Pawmenow/what-dogs-can-eat/main/dogs_can.svg"/>`;
   var dogs_cant = `<img class="svg-image-dog-2" src="https://raw.githubusercontent.com/Pawmenow/what-dogs-can-eat/main/dogs_cant.svg"/>`;
  ...
  var attribute = "<a href='https://www.freepik.com/vectors/sleeping-dog' target='_blank' rel='nofollow' class='text-sm'>Sleeping dog vector created by pch.vector - www.freepik.com</a>";
    ...
    for(var i = 0; i < count; i++){
      ...
      for(var j = 0; j < array.length; j++){
        if(capitalizeFirstLetter(input.value).trim() == array[j]){
          ...
          div.innerHTML = '<p>'+ 'Please insert a value' + '</p>';

        } else {
          div.innerHTML = '<p>'+ 'No informations found :(' + '</p>';
  ...
  if(document.querySelector('.toggle-track')){
      document.querySelector('.toggle-track').remove();
  }
  ...
  function autocompleteMatch(input) {
    ...
    return search_terms.filter(function(term) {
      ...
      if (term.startsWith(input) || termLowerCase.startsWith(input)) {
        return term;
      }
    });
  }
